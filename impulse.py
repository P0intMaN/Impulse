...
def banner():
    print('''\u001b[94m
                        ...
                        ██ ██      ██ ██       ██████  ███████ ███████ ███████ 
                                          ...
                                          \u001b[32m Developed by:\u001b[0m \u001b[32mPratheek 'THE P0intMaN'\u001b[0m
...
choice = int(input("\u001b[92m\nEnter the Choice of Input => 1. Website  ||  2. IP Address of Website --> \u001b[0m"))
if choice == 1 :
    try:
        name = input("\u001b[92m\nEnter the Website address --> \u001b[0m")
        ip = socket.gethostbyname(name)
        port = int(input("\u001b[92mEnter the port to be IMPULSED (\u001b[91mDefault usage: port 80)\u001b[92m -->\u001b[0m "))        
    except:
        print("\u001b[91m Website not found!\u001b[0m ")
        sys.exit(1)     

if choice == 2:
    ip = input('\n\u001b[92m Enter the target IP Address -->\u001b[0m  ')
    port = int(input("\u001b[92mEnter the port to be IMPULSED (\u001b[91mDefault usage: port 80)\u001b[92m -->\u001b[0m "))
if choice > 2:
    error()
